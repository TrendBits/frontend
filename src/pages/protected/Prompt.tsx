...
const Prompt = () => {
  ...
  return (
    <RootLayout className="justify-center items-center flex bg-mainBg">
      <div className="relative z-10 px-5 w-full max-w-4xl py-16 sm:py-0">
        <h2 className="font-fredoka font-medium text-4xl sm:text-5xl text-center text-primaryDark mb-1">AI Trends</h2>
        <h1 className="text-center mb-6 text-sm sm:text-xl font-medium text-gray-700">Discover the latest in artificial intelligence</h1>

        <div className="w-full md:w-[560px] mx-auto bg-mainBg shadow-md rounded-xl border border-primary mb-6">
              ...
              {aiTopicSuggestions.map((suggestion: any, index: number) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white border border-gray-200 rounded-lg p-4 hover:border-primary hover:shadow-md transition-all cursor-pointer group"
                  >
                    <div className="flex items-start gap-3">
                      <div className="text-primary group-hover:text-primaryDark transition-colors">
                        <DynamicIcon 
                          name={iconName} 
                          className="w-4 h-4" 
                          fallback="TrendingUp"
